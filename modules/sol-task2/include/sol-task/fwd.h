...
namespace sol
{
    ...
    class SubmitTask;
    class TaskGraph;
    class TimelineSemaphoreProvider;
    ...
    using SemaphoreProviderPtr         = std::unique_ptr<SemaphoreProvider>;
    using SubmitTaskPtr                = std::unique_ptr<SubmitTask>;
    using TaskGraphPtr                 = std::unique_ptr<TaskGraph>;
    using TimelineSemaphoreProviderPtr = std::unique_ptr<TimelineSemaphoreProvider>;
}  // namespace sol
