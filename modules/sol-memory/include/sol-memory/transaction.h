...
namespace sol
{
    ...
    public:
        ...
        explicit Transaction(TransactionManager& transactionManager);
        ...
        [[nodiscard]] TransactionManager& getTransferManager() noexcept;

        [[nodiscard]] const TransactionManager& getTransferManager() const noexcept;
         ...
         */
        void stage(BufferBarrier barrier, BarrierLocation location);
    ...
    private:
        ...
        std::vector<BufferBarrier>                            preBufferBarriers;
        std::vector<BufferBarrier>                            postBufferBarriers;
